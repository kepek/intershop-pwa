 ...
 *
 * @example
 * <camfil-remind-password-form
 *               (submitPasswordReminder)="requestPasswordReminder($event)"
 * ></camfil-remind-password-form>
 */
@Component({
  selector: 'camfil-remind-password-form',
  templateUrl: './camfil-remind-password-form.component.html',
  styleUrls: ['./camfil-remind-password-form.component.scss'],
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class CamfilRemindPasswordFormComponent implements OnInit {
  /**
