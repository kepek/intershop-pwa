...
export const ENVIRONMENT_DEFAULTS: Environment = {
  ...
  locales: [
    ...
    { lang: 'de_AT', currency: 'EUR', value: 'at', displayName: 'AT', displayLong: 'Austrian German' },
    { lang: 'de_CH', currency: 'CHF', value: 'ch', displayName: 'CH', displayLong: 'Swiss High German' },
