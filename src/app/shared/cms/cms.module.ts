...
import { CamfilCmsLightboxLinkArticleComponent, CamfilCmsLightboxLinkComponent } from './components/camfil-cms-lightbox-link/camfil-cms-lightbox-link.component';
...
@NgModule({
  ...
  declarations: [CamfilCmsLightboxLinkComponent, CamfilCmsLightboxLinkArticleComponent],
