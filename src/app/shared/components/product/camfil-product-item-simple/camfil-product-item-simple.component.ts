...
export interface ProductItemSimpleComponentConfiguration {
  readOnly: boolean;
...
export class CamfilProductItemSimpleComponent implements OnInit, OnDestroy {
  @Input() configuration: Partial<ProductItemSimpleComponentConfiguration> = {};
