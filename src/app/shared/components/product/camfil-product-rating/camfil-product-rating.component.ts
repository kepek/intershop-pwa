 ...
 *
 * @example
 * <camfil-product-rating [product]="product"></camfil-product-rating>
 */
@Component({
  selector: 'camfil-product-rating',
  templateUrl: './camfil-product-rating.component.html',
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class CamfilProductRatingComponent {
  /**
