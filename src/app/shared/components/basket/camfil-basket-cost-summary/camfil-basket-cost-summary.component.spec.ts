...
import { CamfilBasketCostSummaryComponent } from './camfil-basket-cost-summary.component';

describe('Camfil Basket Cost Summary Component', () => {
  let component: CamfilBasketCostSummaryComponent;
  let fixture: ComponentFixture<CamfilBasketCostSummaryComponent>;
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(CamfilBasketCostSummaryComponent);
  ...
  it('should display mocked prices when rendered', fakeAsync(() => {
    ...
    expect(element.textContent.replace(/^\s*[\r\n]*/gm, '')).toMatchInlineSnapshot(
      `"checkout.cart.subtotal.heading$141,796.98-$11.90checkout.order.shipping.labelproduct.price.na.text Battery Deposit Surcharge  shopping_cart.detail.text $595.00checkout.cart.payment_cost.label$3.57checkout.order.total_cost.label$142,470.71checkout.tax.TaxesLabel.TotalOrderVat$22,747.55"`
    );
  }));
