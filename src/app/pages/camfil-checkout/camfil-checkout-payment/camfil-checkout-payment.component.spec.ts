...
import { CamfilCheckoutPaymentComponent } from './camfil-checkout-payment.component';

describe('Camfil Checkout Payment Component', () => {
  let component: CamfilCheckoutPaymentComponent;
  let fixture: ComponentFixture<CamfilCheckoutPaymentComponent>;
  ...
  beforeEach(async () => {
    ...
    await TestBed.configureTestingModule({
      declarations: [
        ...
        MockComponent(CamfilPaymentConcardisCreditCardComponent),
        MockComponent(CamfilPaymentConcardisCreditcardCvcDetailComponent),
        MockComponent(CamfilPaymentConcardisDirectdebitComponent),
      ...
      .overrideComponent(CamfilCheckoutPaymentComponent, {
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(CamfilCheckoutPaymentComponent);
