...
import { CamfilPaymentConcardisDirectdebitComponent } from './camfil-payment-concardis-directdebit.component';

describe('Camfil Payment Concardis Directdebit Component', () => {
  let component: CamfilPaymentConcardisDirectdebitComponent;
  let fixture: ComponentFixture<CamfilPaymentConcardisDirectdebitComponent>;
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(CamfilPaymentConcardisDirectdebitComponent);
