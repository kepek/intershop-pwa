...
import { CamfilPaymentConcardisCreditcardCvcDetailComponent } from './camfil-payment-concardis-creditcard-cvc-detail.component';

describe('Camfil Payment Concardis Creditcard Cvc Detail Component', () => {
  let component: CamfilPaymentConcardisCreditcardCvcDetailComponent;
  let fixture: ComponentFixture<CamfilPaymentConcardisCreditcardCvcDetailComponent>;
  let element: HTMLElement;

  beforeEach(async () => {
    await TestBed.configureTestingModule({
      declarations: [CamfilPaymentConcardisCreditcardCvcDetailComponent, MockComponent(InputComponent)],
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(CamfilPaymentConcardisCreditcardCvcDetailComponent);
