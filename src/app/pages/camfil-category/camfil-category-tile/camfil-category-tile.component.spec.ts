...
describe('Category Tile Component', () => {
  ...
  beforeEach(async(() => {
    ...
    TestBed.configureTestingModule({
      ...
      declarations: [CamfilCategoryTileComponent, MockComponent(CategoryImageComponent), MockPipe(CategoryRoutePipe)],
      providers: [{ provide: ShoppingFacade, useFactory: () => instance(shoppingFacade) }],
    }).compileComponents();
  }));

  beforeEach(() => {
    fixture = TestBed.createComponent(CamfilCategoryTileComponent);
