 ...
 */
@Component({
  selector: 'camfil-cookies-modal',
  templateUrl: './camfil-cookies-modal.component.html',
  styleUrls: ['./camfil-cookies-modal.component.scss'],
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class CamfilCookiesModalComponent implements OnInit {
