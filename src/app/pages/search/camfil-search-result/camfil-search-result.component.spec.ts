...
describe('Camfil Search Result Component', () => {
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(CamfilSearchResultComponent);
  ...
  it('should render headline with search term on template', () => {
    component.orginalSearchTerm = 'Test Search Term';
    component.totalItems = 111;
    translate.set('camfil.search.title.text', '{{1}} - {{2}}');
