...
export class BasketMapper {
  ...
  static convertFormDataToAnonymousBasketData(data: BasketExtensionGuestForm): BasketExtensionGuestData {
    ...
    return {
      ...
      phoneNumber: userDetailsFormGroup.phoneHome,
      companyName: userDetailsFormGroup.companyName1,
      ...
      dlvStreetAddress: deliveryInfoFromGroup.addressLine1,
      dlvZipCode: deliveryInfoFromGroup.postalCode,
      dlvCity: deliveryInfoFromGroup.city,
      dlvCountry: deliveryInfoFromGroup.countryCode,
      invStreetAddress: sameAsDelivery ? deliveryInfoFromGroup.addressLine1 : invoiceAddressFormGroup.addressLine1,
      invZipCode: sameAsDelivery ? deliveryInfoFromGroup.postalCode : invoiceAddressFormGroup.postalCode,
      invCity: sameAsDelivery ? deliveryInfoFromGroup.city : invoiceAddressFormGroup.city,
      invCountry: sameAsDelivery ? deliveryInfoFromGroup.countryCode : invoiceAddressFormGroup.countryCode,
    };
  }
