...
import { CamfilRequisitionWidgetComponent } from './camfil-requisition-widget.component';

describe('Camfil Requisition Widget Component', () => {
  let component: CamfilRequisitionWidgetComponent;
  let fixture: ComponentFixture<CamfilRequisitionWidgetComponent>;
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(CamfilRequisitionWidgetComponent);
    component = fixture.componentInstance;
    element = fixture.nativeElement;

    when(camRequisitionManagementFacade.requisitions$('buyer', 'PENDING')).thenReturn(of(requisitions));
    when(camRequisitionManagementFacade.requisitionsLoading$).thenReturn(of(false));
  });
  ...
  it('should render loading component if requisitions loading', () => {
    when(camRequisitionManagementFacade.requisitionsLoading$).thenReturn(of(true));
