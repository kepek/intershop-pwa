...
import { CamfilApprovalWidgetComponent } from './camfil-approval-widget.component';

describe('Camfil Approval Widget Component', () => {
  let component: CamfilApprovalWidgetComponent;
  let fixture: ComponentFixture<CamfilApprovalWidgetComponent>;
  let element: HTMLElement;

  let requisitionManagementFacade: CamRequisitionManagementFacade;
  ...
  beforeEach(async () => {
    requisitionManagementFacade = mock(CamRequisitionManagementFacade);
    await TestBed.configureTestingModule({
      ...
      providers: [{ provide: CamRequisitionManagementFacade, useFactory: () => instance(requisitionManagementFacade) }],
    }).compileComponents();
  });

  beforeEach(() => {
    fixture = TestBed.createComponent(CamfilApprovalWidgetComponent);
