...
@Component({
  selector: 'camfil-approval-widget',
  templateUrl: './camfil-approval-widget.component.html',
  changeDetection: ChangeDetectionStrategy.OnPush,
})
@GenerateLazyComponent()
export class CamfilApprovalWidgetComponent implements OnInit {
  ...
  ngOnInit() {
    const pendingApprovals$ = this.camRequisitionFacade.requisitions$('approver', 'PENDING');
