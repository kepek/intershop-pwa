...
import { CamfilBudgetBarComponent } from './camfil-budget-bar.component';

describe('Budget Bar Component', () => {
  let component: CamfilBudgetBarComponent;
  let fixture: ComponentFixture<CamfilBudgetBarComponent>;
  ...
  beforeEach(async () => {
    ...
    await TestBed.configureTestingModule({
      ...
      declarations: [CamfilBudgetBarComponent, PricePipe],
      providers: [
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(CamfilBudgetBarComponent);
