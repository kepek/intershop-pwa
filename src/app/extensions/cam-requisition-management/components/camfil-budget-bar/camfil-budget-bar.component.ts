...
@Component({
  selector: 'camfil-budget-bar',
  templateUrl: './camfil-budget-bar.component.html',
  styleUrls: ['./camfil-budget-bar.component.scss'],
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class CamfilBudgetBarComponent implements OnChanges {
  @Input() budget: Price;
