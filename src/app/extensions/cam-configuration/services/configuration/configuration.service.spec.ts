...
describe('Configuration Service', () => {
  ...
  it("should get the camfil server configuration when 'getCamfilServerConfiguration' is called", done => {
    ...
    configurationService.getCamfilServerConfiguration().subscribe(() => {
      // TODO (extMlk): This GET request should point to `camfil_configurations`
