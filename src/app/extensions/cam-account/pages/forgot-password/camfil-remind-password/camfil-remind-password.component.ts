...
@Component({
  ...
  templateUrl: './camfil-remind-password.component.html',
  styleUrls: ['./camfil-remind-password.component.scss'],
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class CamfilRemindPasswordComponent implements OnInit {
