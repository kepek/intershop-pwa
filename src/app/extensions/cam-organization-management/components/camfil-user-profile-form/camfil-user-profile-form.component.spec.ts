...
import { CamfilUserProfileFormComponent } from './camfil-user-profile-form.component';

describe('Camfil User Profile Form Component', () => {
  let component: CamfilUserProfileFormComponent;
  let fixture: ComponentFixture<CamfilUserProfileFormComponent>;
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(CamfilUserProfileFormComponent);
