...
import { CamfilOrganizationHeaderComponent } from './components/camfil-organization-header/camfil-organization-header.component';
...
const exportedComponents = [
  ...
  CamfilOrganizationHeaderComponent,
